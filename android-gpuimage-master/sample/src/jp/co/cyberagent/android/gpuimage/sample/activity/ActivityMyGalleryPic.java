...
public class ActivityMyGalleryPic extends Activity implements OnSeekBarChangeListener,
        ...
        public void onCreate(final Bundle savedInstanceState) {
                ...
                findViewById(R.id.button_gaussian_blur_filter).setOnClickListener(this);
        ...
        public void onClick(final View v) {
                switch (v.getId()) {
                        case R.id.button_gaussian_blur_filter:
                                switchFilterTo(new GPUImageGaussianBlurFilter(100f));
